            ...
            case R.id.selectimage:
                ...
                switchTeamPopup.setWebCamPopupListener(new SwitchTeamPopup.WebCamPopupListener() {
                    ...
                    public void select(TeamSpaceBean teamSpaceBean) {
                        ...
                        TeamSpaceInterfaceTools.getinstance().getSyncRoomList(AppConfig.URL_PUBLIC + "SyncRoom/List?companyID=" + AppConfig.SchoolID + "&teamID=" + teamID,
        ...
        public void onBindViewHolder(RecycleHolder2 holder, int position) {
            ...
            holder.ll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    webCamPopupListener.changeOptions(syncRoomBean, teamSpaceBean2);
                }
            });
