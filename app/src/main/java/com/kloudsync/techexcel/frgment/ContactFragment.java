...
import com.kloudsync.techexcel.adapter.HealthAdapter;
...
//    private View v_linc;
    ...
    private SchoolContactAdapter scAdapter;
...
//        lin_edit = (LinearLayout) view.findViewById(R.id.lin_edit);
        ...
        lin_my_friend = (LinearLayout) view.findViewById(R.id.lin_my_friend);
...
//        vp_contact = (ViewPager) view.findViewById(R.id.vp_contact);
    ...
    /*private void initVP() {
        ...
        ListVFragment listvFragment = new ListVFragment();
        ListVsFragment listVsFragment = new ListVsFragment();

        mTabs = new ArrayList<Fragment>();
        mTabs.add(listvFragment);
        mTabs.add(listVsFragment);
        ...
        vp_contact.addOnPageChangeListener(new MyPagerListener());
    ...
    /*protected class MyPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(v_linc.getLayoutParams());
            lp.setMargins((int) ((width * (position + positionOffset)) / 2), 0, 0, 0);
            v_linc.setLayoutParams(lp);
        }
...
//        loginget.CustomerRequest(getActivity());
    ...
    private class MyOnitem implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            Customer cus = isCustomer ? cuslist.get(position) : sclist
                    .get(position);
            if (et_search.length() != 0) {
...
//                    mPopupWindow.showAsDropDown(v);
        ...
        public void CreateNewUM() {
            ...
            ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation(getActivity(),
                    new Pair(tv_mfriend, MyFriendsActivity.俺の朋友));
