...
import com.kloudsync.techexcel.ui.UpoadNull;
            ...
            httpHandler = http.send(HttpRequest.HttpMethod.POST, url, params,
                    new RequestCallBack<String>() {
                        ...
                        public void onStart() {
                            ...
                            if(null == UpoadNull.instance || UpoadNull.instance.isFinishing()) {
                                puo.getPopwindow(MainActivity.instance, "");
                                puo.StartPop(MainActivity.instance.getWindow().getDecorView());
                            } else {
                                puo.getPopwindow(UpoadNull.instance, "");
                                puo.StartPop(UpoadNull.instance.getWindow().getDecorView());
                            }
                        }
